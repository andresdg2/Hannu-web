...
const Header = ({ selectedCategory, setSelectedCategory, showAdmin, setShowAdmin, isAdmin, setIsAdmin, searchQuery, setSearchQuery, showSearch, setShowSearch }) => {
  ...
  return (
    <header className="header">
      ...
      {showMainMenu && (
        <div className="main-menu-overlay" onClick={() => setShowMainMenu(false)}>
          <div className="main-menu" onClick={e => e.stopPropagation()}>
            ...
            <div className="main-menu-content">
              ...
              <div className="menu-section">
                ...
                <ul>
                  <li>
                    <button onClick={() => scrollToSection('immediate-delivery')}>
                      Entrega Inmediata
                    </button>
                  </li>
                  <li>
                    <button onClick={() => scrollToSection('policies-section')}>
                      Políticas Hannu
                    </button>
                  </li>
                  <li>
                  ...
                  <li>
                    <button onClick={() => scrollToSection('objetivo-section')}>
